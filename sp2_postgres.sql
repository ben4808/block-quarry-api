...
CREATE OR REPLACE FUNCTION public.frontier_query_indexed(
	query text,
	data_source text,
	page int,
...
begin
    ...
    q3 := concat('select ds.entry, ds.display_text, ds.data_source_score, (ds.views-1) as views ', q);
    ...
    return query execute q3 using query, page, records_per_page;
end;
$BODY$;
